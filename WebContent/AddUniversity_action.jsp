...
<%
	...
	ah.addUniversity(school, request.getParameter("state"), request.getParameter("location"), request.getParameter("control"), 
	...
	response.sendRedirect("ManageUniversities.jsp?Error=-2");
%>
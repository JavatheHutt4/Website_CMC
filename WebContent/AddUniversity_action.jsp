...
<%
	...
	ah.addUniversity(request.getParameter("school"), request.getParameter("state"), request.getParameter("location"), request.getParameter("control"), 
	...
	ah.addUniversityEmphasis(request.getParameter("school"), request.getParameter("emphasis1"));
	ah.addUniversityEmphasis(request.getParameter("school"), request.getParameter("emphasis2"));
	ah.addUniversityEmphasis(request.getParameter("school"), request.getParameter("emphasis3"));
	ah.addUniversityEmphasis(request.getParameter("school"), request.getParameter("emphasis4"));
	ah.addUniversityEmphasis(request.getParameter("school"), request.getParameter("emphasis5"));
%>